...
import { LayoutDashboard, ShoppingCart, Settings, LogOut, Printer, Database, UserCircle, ChevronDown, ChevronRight, Layers, Box, Wrench } from 'lucide-react';
  ...
  return (
    <div class="hidden md:flex flex-col w-64 bg-white border-r border-slate-200 h-screen sticky top-0 font-sans z-50">
      <div class="p-6 border-b border-slate-100 flex items-center gap-3">
         ...
         <span class="text-xl font-bold text-slate-900 tracking-tight">DigitalMarket</span>
      </div>
          ...
          return (
            <div key={item.id}>
                <button
                    ...
                    class={`w-full flex items-center justify-between px-4 py-3 rounded-lg text-sm font-medium transition-colors mb-1 ${
                    ...
                    <div class="ml-9 space-y-1 mb-2 border-l border-slate-200 pl-2">
                        {item.subItems?.map(sub => (
                            <button
                                ...
                                class={`w-full flex items-center px-4 py-2 rounded-lg text-sm transition-colors ${
                                    currentView === sub.id
      ...
      <div class="p-4 border-t border-slate-100">
        {currentUser?.role === 'client' && (
            ...
            class={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors mb-2 ${
